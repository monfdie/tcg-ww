...
const Tournament = require('./models/Tournament'); // Если используется в socket
...
io.on('connection', (socket) => {
    ...
    socket.on('action', ({ roomId, charId }) => {
        ...
        // Если у врага есть, но не иммун -> нельзя
